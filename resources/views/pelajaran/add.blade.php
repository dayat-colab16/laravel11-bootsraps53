  ...
  <div class="card-header">
    ...
    <form method="POST" action="{{ route('pelajaran.store') }}">
      @csrf
            ...
            <div class="row mb-3">
              <label for="id_pelajaran" class="col-sm-2 col-form-label">ID Pelajaran</label>
              <div class="col-sm-10">
                <input type="text" class="form-control form-control-sm @error('id') is-invalid @enderror" id="id" name="id">
                @error('nama_pelajaran')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
